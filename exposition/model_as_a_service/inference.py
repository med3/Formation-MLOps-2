...
def predict_endpoint():
   ...
   print(received_wind_speed_avg)
   received_data_df['Ws1_avg'] = received_wind_speed_avg
   prepated_features_df = prepare_features(data=received_data_df, training_mode=False)
   print(prepated_features_df)
   predictions = predict(features=prepated_features_df, model_path=MODEL_PATH).to_dict()
